...
namespace Financial.Tests.WebApplication.Controllers
{
    public class ControllerTestsBase
    {
        public ControllerTestsBase()
        {
            ...
            //_dataAssetSettings = FakeAssets.InitialFakeAssetSettings().ToList();
            //_dataAssetTransactions = FakeAssets.InitialFakeAssetTransactions().ToList();
            ...
            //_dataTransactionTypes = FakeSettingTypes.InitialFakeTransactionTypes().ToList();
